...
export function BudgetForm({ onSubmit, onCancel, isLoading }: BudgetFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">예산 추가</h3>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-xs text-gray-500 dark:text-slate-400">50%, 80%, 100% 임계값에서 알림이 전송됩니다.</p>
