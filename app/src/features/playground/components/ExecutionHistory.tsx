  ...
  return (
    <div className="rounded-2xl border border-slate-200/60 bg-white shadow-sm">
      <div className="border-b border-slate-100 px-5 py-3">
        <h3 className="text-sm font-semibold text-slate-700">실행 기록</h3>
      </div>
      <div className="divide-y divide-slate-50">
        {history.map((item) => (
          <button
            ...
            className="flex w-full items-center gap-3 px-5 py-3 text-left hover:bg-slate-50/50 transition-colors"
          >
            <span
            ...
            <span className="shrink-0 text-[11px] text-slate-300 w-16 text-right">
