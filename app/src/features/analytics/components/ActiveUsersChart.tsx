...
export function ActiveUsersChart({ data, isLoading }: ActiveUsersChartProps) {
  ...
  if (data.length === 0) {
    return (
      <Card>
        <CardHeader><h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">일별 활성 사용자</h3></CardHeader>
  ...
  return (
    <Card>
      <CardHeader>
        <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">일별 활성 사용자</h3>
      </CardHeader>
      <CardContent>
        <div className="h-72">
