...
export function CompleteStep() {
  return (
    <div className="text-center">
      ...
      <p className="mt-2 text-slate-500 dark:text-slate-400">이제 LLM 비용을 효율적으로 관리할 준비가 되었습니다</p>

      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        {NEXT_ACTIONS.map((a) => (
          <div
            key={a.title}
            className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-900 p-4 shadow-sm transition-colors hover:border-blue-200 hover:bg-blue-50 dark:hover:bg-blue-950/30"
          >
