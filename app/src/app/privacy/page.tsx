        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-white dark:bg-slate-900 p-8 shadow-sm">
            ...
            <div className="space-y-6 text-gray-700 dark:text-slate-300">
              <section>
                <h2 className="mb-3 text-2xl font-semibold text-gray-900 dark:text-slate-100">1. 수집하는 정보</h2>
              ...
              <section>
                <h2 className="mb-3 text-2xl font-semibold text-gray-900 dark:text-slate-100">2. 정보 사용 방법</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-3 text-2xl font-semibold text-gray-900 dark:text-slate-100">3. 데이터 보안</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-3 text-2xl font-semibold text-gray-900 dark:text-slate-100">4. 고객님의 권리</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-3 text-2xl font-semibold text-gray-900 dark:text-slate-100">5. 문의하기</h2>
                <p className="leading-relaxed">
